...
/*defining to initialize the DHT-11 sensor*/
...
/*Uses Round-Robin scheduling for tasks in the same priority; 5 total tasks to schedule*/
...
/*adding the first task for the scheduler; first task is to read the DHT-11 sensor values*/
...
/*This task gives indication through Buzzer if PPM levls go high*/
